...
- Each quest category has a unique symbol and color for easy scanning.
...
- **Export CSV** downloads your current profile stats and quest list (including categories).
- **Import CSV** restores profile stats and quests from a previously exported file.

## Recent history and undo

- The **Recent Battle Log** tracks up to 10 recent complete/miss actions.
- Use **Undo** to restore your previous state from a log entry.
